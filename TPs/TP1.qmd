...
1.7. ¿Por qué da error esta operación?
...
1.8. Explorar estas distintas formas de extraer información del vector `c("banana", "pera", "durazno", "anana")`. Primero crear el vector en la consola y asignarlo al vector `frutas`. Luego correr cada caso en la consola y explicar en pocas palabras qué es lo que sucede.
...
1.9. Explorar distintas formas de extraer información del vector `alturas_cm` definido en el ejercicio 1.6. Escribir una frase explicando qué hace cada una. ¿Por qué da error la última?
