...
- "...allows you to turn raw data into understanding, insight, and knowledge" (Wickham, Çetinkaya-Rundel, and Grolemund). [https://r4ds.hadley.nz/](https://r4ds.hadley.nz/)
- "...the process of formulating a quantitative question that can be answered with data, collecting and cleaning the data, analyzing the data, and communicating the answer to the question to a relevant audience" (Leek and Peng). [http://jtleek.com/ads2020/](http://jtleek.com/ads2020/)
- "...the process of generating insight from data through reproducible and auditable processes" (Timbers, Campbell, and Lee). [https://datasciencebook.ca/](https://datasciencebook.ca/)

::: footer
[Telling Stories with data](https://tellingstorieswithdata.com/01-introduction.html#what-is-data-science-and-how-should-we-use-it-to-learn-about-the-world)
:::
...
-   **causales**: ¿cambiar una variable, cambia el valor de otra variable?
